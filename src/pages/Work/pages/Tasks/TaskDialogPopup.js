...
import {getUserById, getUserGroup, getUserByIds, getUserImg, getTaskInfo, users} from "../../../../utils/Request.js"
...
import {calendarBtn, closeBtn, hintBtn, messageBtn, phoneBtn} from '../../../../utils/btns.js'
...
class TaskDialogPopup extends React.Component {
    constructor(props) {
		...
		this.task_info = getTaskInfo(this.task.id).tInfo
		this.u = []
		users.forEach(el => {
			this.u[el.user_id] = el
		})
    ...
    createLinked(event) {
        ...
        element.style.inset = '77px 5px auto auto'
	...
	removeSelected(elSel) {
		if (elSel !== null) {
			...
			elSel.firstChild.firstChild.classList.toggle('edws-Dialog__tabs-selected')
		}
	}
	...
	renderLenta(e) {
		...
		if (!fc.classList.contains('controls-marker_style-tabsprimary')) {
			...
			fc.firstChild.firstChild.classList.toggle('edws-Dialog__tabs-selected')
		}
		if (el !== null) {
	...
	renderMain(e) {
		let el = e.currentTarget,
			elSel = document.querySelector('.controls-Tabs__itemClickableArea.controls-marker_style-tabsprimary:not([name="TabContent0"])')
		this.removeSelected(elSel)
		if (!el.firstChild.classList.contains('controls-marker_main')) {
    ...
    render() {
        return (
            <>
                <div className={'controls-Popup ws-float-area-show-complete controls-Scroll_webkitOverflowScrollingTouch controls-Stack__last-item'} templatename={'Recruitment/VacancyEnquiry/document:Dialog'} template={'Recruitment/VacancyEnquiry/document:Dialog'} tabIndex={0} key={'popup-' + this.id} style={{ zIndex: 10, position: 'fixed', inset: '0px 54px 0px auto', width: '800px', maxWidth: '1400px', minWidth: '450px', height: 'auto' }}>
                    <div className={'controls_popupTemplate_theme-default controls-Stack__content-wrapper ws-workspace-width-650 controls_popupTemplate_theme-default controls-Popup__template'} tabIndex={0}>
                        <div className={'edo3-Dialog__formController edo3-Dialog__fullHeight ws-flexbox ws-flex-grow-1 ws-flex-shrink-1 controls-Stack__content controls-hint-area'} tabIndex={0}>
                                                ...
                                                <div className={'controls-StackTemplate__top-area-content'}>
                                                    <div className={'controls-StackTemplate__headerContentTemplate controls-StackTemplate__headerContentTemplate_padding-right'}>
                                                        <div className={'edo3-Dialog__head-firstLine edo3-Dialog__head-item ws-flexbox ws-flex-grow-1 ws-flex-shrink-1 ws-align-items-center ws-justify-content-between ws-ellipsis'} tabIndex={0}>
															{this.task.tstatus === 2 ? <div className={'edo3-DialogState   edo3-DialogState__clickable edo3-Dialog__state ws-flex-last'}>
																<div title={'Обработка завершена положительно'} className={'edo3-DialogState__innerState icon-24 icon-Successful icon-done'} />
															</div> : ''}
															{this.task.tstatus === 3 ?<div className={'edo3-DialogState   edo3-DialogState__clickable edo3-Dialog__state ws-flex-last'} tabIndex={0}>
																<div title={'Обработка завершена отрицательно'} className={'edo3-DialogState__innerState icon-24 icon-Unsuccess icon-error'} />
																<div title={'Не выполнено'} className={'edo3-DialogState__caption ws-ellipsis'}>Не выполнено</div>
															</div>: ''}
                                                            <div className={'edo3-Dialog__head-firstLine-buttons ws-flex-shrink-1 ws-flex-first ws-flexbox ws-ellipsis'}>
                                                                ...
                                                                <div className={'ws-flexbox ws-align-items-center ws-ellipsis ws-flex-shrink-2'}>
                                                                    <div tabIndex={90} className={'edo3-PassageButton ws-flexbox edo3-Dialog__head-firstLine-passageButton ws-ellipsis ws-flex-shrink-1'}>
																		{this.task.tstatus === 1 ? <div className={'extControls-doubleButton extControls-doubleButton-inside  extControls-doubleButton_cursor edo3-PassageButton__button ws-ellipsis'} tabIndex={0}>
                                                                            <div className={'extControls-doubleButton__wrapper ws-flexbox ws-align-items-baseline extControls-doubleButton__wrapper_style-primary controls-inlineheight-m'} onClick={this.openStatusPopup}>
																		...
																		{this.task.tstatus === 0 ? <span className={'controls-BaseButton controls-Button_outlined controls-Button_radius-outlined controls-Button_hoverIcon controls-Button_clickable controls-Button_outlined_style-primary controls-Button_bg-same controls-fontsize-m controls-Button_button__wrapper-fontsize-m controls-Button_outlined_shadow-none controls-notFocusOnEnter edo3-PassageButton__button ws-ellipsis controls-inlineheight-default controls-Button-inlineheight-default controls-Button_outlined_default'} title={'На выполнение'} tabIndex={0} onClick={changeStatus} data-ns={1} data-id={this.task.id}>
																		...
																		{this.task.tstatus === 3 || this.task.tstatus === 2 ? <div className={'extControls-doubleButton extControls-doubleButton-inside extControls-doubleButton_cursor edo3-PassageButton__button ws-ellipsis'} tabIndex={0}>
																			<div className={'extControls-doubleButton__wrapper ws-flexbox ws-align-items-baseline extControls-doubleButton__wrapper_style-primary controls-inlineheight-m'}>
																				<div data-qa={'extControls-doubleButton__icon'} className={'controls-Button-inlineheight-m controls-inlineheight-m controls-Button_filled_m controls-Button_circle_height-m extControls-doubleButton__icon extControls-doubleButton__mainAction extControls-doubleButton__icon_captionPosition-start extControls-doubleButton__icon-absolute'} name={'Button'} tabIndex={0} title={'Проверено'}>
																					<div className={'ws-flexbox ws-justify-content-center ws-align-items-center controls-Button_clickable extControls-doubleButton__mainButton  controls-Button_filled_style-primary'}>
																						<svg fillRule={'evenodd'} tabIndex={-1} className={'controls-BaseButton__icon controls-icon controls-icon_size-s controls-icon_style-contrast controls-icon_svg'}>
																							<use xlinkHref={'/asset/resource/Controls-icons/arrows.svg#icon-Follow'} />
																						</svg>
																					</div>
																				</div>
																				<span className={'extControls-doubleButton__wave extControls-doubleButton_caption-m extControls-doubleButton__mainAction extControls-doubleButton__wave_style-primary extControls-doubleButton__wave-standard extControls-doubleButton_bordered extControls-doubleButton_bordered-m_captionPosition-start extControls-doubleButton__wave_captionPosition-start  extControls-doubleButton_text-default controls-fontsize-m'}>
																					<span name={'mainActionCaption'} data-qa={'extControls-doubleButton__wave'} className={'ws-ellipsis extControls-doubleButton__captionContent-start-m'}>Проверено</span>
																				</span>
																				<span data-qa={'extControls-doubleButton__caption'} title={'Проверка'} className={'ws-ellipsis extControls-doubleButton__caption extControls-doubleButton_caption-m controls-inlineheight-m extControls-doubleButton_bordered  extControls-doubleButton_same  extControls-doubleButton_bordered-m_captionPosition-start extControls-doubleButton__caption_captionPosition-start extControls-doubleButton_text-default controls-fontsize-m extControls-doubleButton__caption_style-default extControls-doubleButton_fontsize-m'}>
																					<span className={'extControls-doubleButton__captionContent-start-m ws-ellipsis'}>Проверка</span>
																				</span>
																			</div>
																		</div> : ''}
                                                                    </div>
                                            ...
                                            <div className={'controls-StackTemplate__content-area controls-StackTemplate_backgroundColor'}>
                                                <div className={'edo3-Dialog__bodyContent edo3-Dialog__fullHeight ws-flexbox ws-flex-column ws-flex-grow-1 ws-flex-shrink-1 controls-background-stack'} tabIndex={0}>
                                                    <div className={'controls-background-stackHeader controls-padding_left-m controls-padding_right-m'} tabIndex={0}>
														{this.task.tstatus === 3 ? <div className={'edo3-Comment ws-flexbox controls-padding_bottom-2xs'} tabIndex={0}>
															<div className={'edo3-Comment__content'}>
																<div className={'edo3-Comment__photo'}>
																	<div className={'person-Collage__grid person-Collage__grid_size-one ws-flex-shrink-0 person-Wrapper__container undefined controls-image_border-small controls_Person_theme-default'} name={'messageSender'} tabIndex={0} style={{width: '24px', height: '24px'}}>
																		<div className={'person-Collage__grid_cell person-Collage__grid_cell_rows-2 ws-flexbox ws-align-items-center ws-justify-content-center'}>
																			<div className={'person-Wrapper__pictureContainer ws-flex-shrink-0 person-Wrapper__container undefined person-Wrapper__image_noRound controls-PopupPreviewer person-Wrapper__clickable'} title={0} style={{lineHeight: '24px', height: '24px', width: '24px'}}>
																				<picture className={'ws-flexbox person-Wrapper__picture'}>
																					{getUserImg(this.task_info[2].tclose_id)}
																				</picture>
																...
																<div className={'edo3-Comment__mask'}>
																	<div className={'edo3-Comment__drop edo3-Comment__style--default'} />
																</div>
																<div className={'edo3-Comment__comment-content ws-ellipsis ws-flexbox'}>
																	<div name={'commentCloudElement'} className={'edo3-Comment__comment ws-ellipsis ws-flex-shrink-1 edo3-Comment__style--default'} style={{paddingLeft: '8px', paddingRight: '8px'}}>
																		<div className={'edo3-Comment__message ws-ellipsis'}>
																			<div title={(new Date(+this.task_info[2].ts_create)).toLocaleString('ru-RU', {day: '2-digit', month: '2-digit', year: '2-digit'})} className={'edo3-Comment__data-event ws-flex-shrink-0'}>{(new Date(+this.task_info[2].ts_create)).toLocaleString('ru-RU', {day: '2-digit', month: '2-digit'})}</div>
																			<div title={this.u[+this.task_info[2].tclose_id].name + ': ' + this.task_info[2].ts_comment_complete} tabIndex={0} className={'edo3-Comment__author-name ws-flex-shrink-0'}>{this.u[+this.task_info[2].tclose_id].name + ':'}</div>
																			<div title={this.u[+this.task_info[2].tclose_id].name + ': ' + this.task_info[2].ts_comment_complete} className={'edo3-Comment__text-message ws-ellipsis ws-flex-shrink-1'}>
																				<div className={'ws-ellipsis controls-DecoratorWrapURLs'} tabIndex={-1}>{this.task_info[2].ts_comment_complete}</div>
																			</div>
																		</div>
																	</div>
																</div>
                                                    ...
                                                    <div className={'edo3-DialogLayout ws-flexbox ws-flex-column ws-flex-grow-1 ws-flex-shrink-1 edo3-Dialog__layout controls-background-stack'} tabIndex={1100}>
                                                        <div className={'controls-Tabs controls-Tabs__horizontal  controls-Tabs_inlineHeight-s edo3-DialogLayout-tabs controls-background-stackHeader ws-flex-shrink-0'} tabIndex={-1} name={'container'}>
                                                            <div name={'wrapper'} className={'controls-Tabs-wrapper controls-Tabs-wrapper__horizontal'}>
                                                                        ...
                                                                        <div className={'controls_editableArea_theme-default controls-EditableArea  controls-EditableArea_readonly edo3-DateNumber__editor ws-flexbox ws-align-items-baseline'} tabIndex={0}>
                                                                            <div className={'controls-EditableArea__wrapper'}>
                                                                                <div className={'ws-flexbox ws-align-items-baseline'} tabIndex={0}>
                                                                                    <div className={'controls_editableArea_theme-default controls-EditableArea__editorWrapper controls-Tabs__content_text ws-flex-shrink-0 edo3-DateNumber__inputMargin controls-Tabs__content_text'} tabIndex={0}>
                                                                                        <div className={'controls-EditableArea__Text controls-text- controls-fontweight-default controls-inlineheight-default controls-fontsize-l'}>
                                                                                            <div className={'controls-EditableArea__Text__wrapper'}>
                                                                                                ...
                                                                                                <div className={'controls-EditableArea__Text__inner'}>{(new Date(+(this.task.tstart_date !== '' ? this.task.tstart_date : this.task.tdate))).toLocaleString('ru-RU', {day: '2-digit', month: '2-digit', year: '2-digit'})}</div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div title={this.task.id} className={'controls_editableArea_theme-default controls-EditableArea__editorWrapper controls-Tabs__content_additionaltext ws-flex-shrink-1 edo3-DateNumber__textInput controls-Tabs__content_additionaltext'} tabIndex={0}>
                                                                                        <div className={'controls-EditableArea__Text controls-text- controls-fontweight-default controls-inlineheight-default controls-fontsize-l'}>
                                                                                            <div className={'controls-EditableArea__Text__wrapper'}>
                                                                                                <span className={'controls-EditableArea__Text__baseline'}>﻿</span>
                                                                ...
                                                                {/*<div name={'tabpublish'} data-name={'publish'} title={'Публикации'} className={'controls-Tabs__item controls-Tabs__item_inlineHeight-s controls-Tabs__item-maxWidth controls-Tabs__item_align_right controls-Tabs__item_default controls-Tabs__item_notShrink'} style={{order: 30}}>*/}
																...
																{/*		<div className={'ws-flexbox controls-Tabs__item_state_default controls-text-secondary'} ws-creates-context={'true'} ws-delegates-tabfocus={'true'}>*/}
																{/*			<div className={'controls-text-readonly hr-fw_n'} tabIndex={0}>Не опубликована</div>*/}
																{/*		</div>*/}
																{/*	</div>*/}
																{/*</div>*/}
																{/*<div name={'tabcandidates'} title={'Кандидаты'} data-name={'candidates'} className={'controls-Tabs__item controls-Tabs__item_inlineHeight-s controls-Tabs__item-maxWidth controls-Tabs__item_align_right controls-Tabs__item_default controls-Tabs__item_notShrink'} style={{order: 31}}>*/}
																...
																{/*		<div className={'ws-flexbox ws-align-items-center hr-h_100 controls-Tabs__item_state_default controls-text-secondary'} tabIndex={0}>*/}
																{/*			<div className={'ws-flexbox ws-align-items-baseline controls-inlineheight-s'} tabIndex={0}>*/}
																{/*				<div className={'controls-icon_size-m controls-icon_style-secondary icon-AddContact controls-icon ws-align-self-center controls-fontweight-default'} ws-creates-context={'true'} ws-delegates-tabfocus={'true'} tabIndex={0} />*/}
																{/*			</div>*/}
																{/*		</div>*/}
																{/*	</div>*/}
																{/*</div>*/}
																{/*<div name={'tabdiscussions'} title={'Обсуждения'} data-name={'discussions'} className={'controls-Tabs__item controls-Tabs__item_inlineHeight-s controls-Tabs__item-maxWidth controls-Tabs__item_align_right controls-Tabs__item_default controls-Tabs__item_notShrink'} style={{order: 32}}>*/}
																{/*	<div name={'TabContent3'} className={'controls-Tabs__itemClickableArea controls-Tabs__itemClickableArea_inlineHeight-s  controls-marker controls-marker_horizontal controls-marker_tabsThickness_horizontal controls-marker_state-default controls-Tabs__itemClickableArea_type-horizontal-default'}>*/}
																{/*		<div className={'edo3-DocumentTabHeader ws-inline-flexbox ws-align-items-baseline ws-ellipsis controls-Tabs__item_state_default controls-text-secondary'} title={'Обсуждения'} tabIndex={0}>*/}
																{/*			<div className={'controls-icon_size-m controls-icon_style-secondary icon-Chat controls-icon edo3-DocumentTabHeader__icon'} ws-creates-context={'true'} ws-delegates-tabfocus={'true'} tabIndex={0} />*/}
																{/*		</div>*/}
																{/*	</div>*/}
																{/*</div>*/}
                                                                ...
                                                                {/*    </div>*/}
                                                                {/*</div>*/}
                                                                <div name={'tabtimeline'} data-name={'timeline'} className={'controls-Tabs__item controls-Tabs__item_inlineHeight-s controls-Tabs_horizontal-padding-xs_last controls-Tabs__item-maxWidth controls-Tabs__item_align_right controls-Tabs__item_extreme controls-Tabs__item_extreme_last controls-Tabs__item_notShrink'} style={{order: 33}} onClick={this.renderLenta}>
                                                                    <div name={'TabContent4'} className={'controls-Tabs__itemClickableArea controls-Tabs__itemClickableArea_inlineHeight-s  controls-marker controls-marker_horizontal controls-marker_tabsThickness_horizontal controls-marker_state-default controls-Tabs__itemClickableArea_type-horizontal-default'}>
                                                                        <div className={'edo3-DocumentTabHeader ws-inline-flexbox ws-align-items-baseline ws-ellipsis controls-Tabs__item_state_default controls-text-secondary'} title={'Лента'} tabIndex={0}>
                                                                            <div className={'controls-icon_size-m controls-icon_style-secondary icon-Lenta controls-icon edo3-DocumentTabHeader__icon'} ws-creates-context={'true'} ws-delegates-tabfocus={'true'} tabIndex={0} />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className={'controls-LoadingIndicator controls-SwitchableArea ws-flex-grow-1 edo3-Dialog__fullHeight edo3-DialogLayout__relativeContainer controls-background-stack ws-flexbox ws-flex-grow-1 ws-flex-shrink-1'} tabIndex={2}>
                                                            <div className={'edo3-Dialog__fullHeight ws-flexbox ws-flex-grow-1 ws-align-self-stretch .edo3-Dialog__drag-and-drop-area--19253'} tabIndex={3} data-key={'main'} key={'main'}>
                                                                                                                ...
                                                                                                                <div className='person-Collage__grid person-Collage__grid_size-one ws-flex-shrink-0 person-Wrapper__container undefined controls-image_border-large controls_Person_theme-default edo3-Sticker__photo' tabIndex={0} style={{ width: '32px', height: '32px' }}>
                                                                                                                    <div className='person-Collage__grid_cell person-Collage__grid_cell_rows-2 ws-flexbox ws-align-items-center ws-justify-content-center'>
                                                                                                                        <div className='person-Wrapper__pictureContainer ws-flex-shrink-0 person-Wrapper__container undefined person-Wrapper__image_noRound controls-PopupPreviewer person-Wrapper__clickable' tabIndex={0} style={{ lineHeight: '32px', height: '32px', width: '32px' }}>
                                                                                                                            <picture className='ws-flexbox person-Wrapper__picture'>
																																{getUserImg(this.author.user_id)}
                                                                                                                            </picture>
                                                                                                            ...
                                                                                                            <div className='person-Collage__grid person-Collage__grid_size-one ws-flex-shrink-0 person-Wrapper__container undefined controls-image_border-large controls_Person_theme-default edws-StaffChooser__photo ws-flex-shrink-0 ws-flex-grow-0 ws-ellipsis' tabIndex={0} style={{ width: '40px', height: '40px' }}>
                                                                                                                <div className='person-Collage__grid_cell person-Collage__grid_cell_rows-2 ws-flexbox ws-align-items-center ws-justify-content-center'>
                                                                                                                    <div className='person-Wrapper__pictureContainer ws-flex-shrink-0 person-Wrapper__container undefined person-Wrapper__image_noRound controls-PopupPreviewer person-Wrapper__clickable' tabIndex={0} style={{ lineHeight: '40px', height: '40px', width: '40px' }}>
                                                                                                                        <picture className='ws-flexbox person-Wrapper__picture'>
																															{getUserImg(this.ispolns[0].user.user_id)}
                                                                                                                        </picture>
                                                                                                                    ...
                                                                                                                    <div ws-creates-context='true' ws-delegates-tabfocus='true' className='controls-StickyBlock  controls-background-default-sticky  ' data-stickyblockid='4' tabIndex={0} style={{ top: '0px' }}>
                                                                                                                        <div className='docview3-List__header ws-flexbox ws-flex-shrink-0 ws-align-items-center controls-margin_left-m docview3-List__header_height controls-StickyBlock__content' name='header' tabIndex={0} data-stickyblockid='4'>
                                                                                                                            <div className='edo3-FileViewer__before-search-template-area ws-flexbox ws-align-items-center' tabIndex={0}>
																																...
																																{/*			<span className='controls-BaseButton__wrapper controls-Button__wrapper_viewMode-link controls-BaseButton__wrapper_captionPosition_end controls-Button_textAlign-none'>*/}
																																{/*				<i className='controls-Button__icon controls-BaseButton__icon controls-icon_size-s controls-icon_style-label controls-icon icon-Attach' tabIndex={-1}/>*/}
																																...
																																{/*			<span className='controls-BaseButton__wrapper controls-Button__wrapper_viewMode-link controls-BaseButton__wrapper_captionPosition_end controls-Button_textAlign-none'>*/}
																																{/*				<i className='controls-Button__icon controls-BaseButton__icon controls-icon_size-s controls-icon_style-label controls-icon icon-TFTask' tabIndex={-1}/>*/}
                                                                                                                        ...
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_top' style={{ top: '-2px' }} />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_top2' />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_top2Right' />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_bottomLeft' style={{ bottom: '-2px' }} />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_bottomRight' style={{ bottom: '-2px' }} />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_left' style={{ left: '-2px' }} />
                                                                                                                        <div data-stickyblockid='4' className='controls-StickyBlock__observationTarget_right' style={{ right: '-2px' }} />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>

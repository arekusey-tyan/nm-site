		...
		return (
			<div style={{width: 'inherit', height: 'inherit'}}>
				...
				<div className='bodyContent controls_theme__wrapper controls_theme-default undefined' tabIndex={0}>
					<div id='popup' className='controls-PopupContainer ws-float-area-stack-panel-overflow' tabIndex={0}></div>
					<div className='page-Controller bodyContent__zIndex-context' tabIndex={0}>
						<div className='nanomagicPage-ProgressBar page-Controller__progressBar' tabIndex={0}>
							<div name='progressBarStart' className=''></div>
							<div name='progressBarEnd' className=''></div>
						</div>
						<div tabIndex={0}></div>
						<div className='page-Controller__content controls-hint-area' tabIndex={0}>
							<div name='page' className='ws-flexbox ws-flex-column nanomagicPage-MainLayout controls-BlockLayout_background ws-site-width-1600' tabIndex={0} style={{maxWidth: '1600px'}}>
